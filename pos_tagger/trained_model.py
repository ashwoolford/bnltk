    ...
    def path_generator(self):
        ...
        if platform.system() == "Windows":
            self.model_path = (
                "C:\\Users\\"
                + getpass.getuser()
                + "\\bnltk_data\\pos_data\\keras_mlp_bangla.h5"
            )
            self.tagged_data_path = (
                "C:\\Users\\"
                + getpass.getuser()
...
class BanglaPosTagger:
    ...
    def load(self):
        ...
        train_test_cutoff = int(0.80 * len(self.sentences))
    ...
    def add_basic_features(self, sentence_terms, index):
        ...
        return {
            ...
            "next_word": (
                "" if index == len(sentence_terms) - 1 else sentence_terms[index + 1]
            ),
        }
