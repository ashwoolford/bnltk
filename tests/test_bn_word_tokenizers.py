...
class TestTokenizers(unittest.TestCase):
    ...
    def test_bn_word_tokenizer(self):
        self.assertEqual(Tokenizers.bn_word_tokenizer("আমি বই পড়ছি।"),["আমি", "বই", "পড়ছি", "।"])
        self.assertEqual(Tokenizers.bn_word_tokenizer("তুমি কোথায় যাচ্ছ?"), ["তুমি", "কোথায়", "যাচ্ছ", "?"])
        self.assertEqual(Tokenizers.bn_word_tokenizer("আজ আবহাওয়া খুব ভালো।"), ["আজ", "আবহাওয়া", "খুব", "ভালো", "।"])
        self.assertEqual(Tokenizers.bn_word_tokenizer("বাচ্চারা,,, খেলছে।।"), ["বাচ্চারা", ",", ",", ",", "খেলছে", "।", "।"])
        self.assertEqual(Tokenizers.bn_word_tokenizer("বাচ্চারা,, , খেলছে।।"), ["বাচ্চারা", ",", ",", ",", "খেলছে", "।", "।"])
